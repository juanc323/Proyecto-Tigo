              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <?php 
                   ...
                   <td>
                     <select class="form-select" aria-label="Default select example" name="filth">
                         <option selected>Filtrar Por</option>
                         <option value="tipo" name="tipo">Tipo</option>
                          <option value="estad" >Estado</option>
                  ...
                  <div class="col col-xs-6 text-right">
                    ...
                    <td><a class='btn btn-danger' href="EliminarReq.php"><em class='fa fa-trash'></em></a></td>
                 ...
                 $result=mysqli_query($conexion,$sql);
                     ...
                     <form method="post" action="../C/Controlador_Eliminareq.php">
                       ...
                       <input type="hidden" name="elimiden" value="<?php echo $mostrar['Identificador']?>">
                         <label>
                          <td><input type="Submit" id="<?php echo $mostrar['idInfo_Requerimiento'] ?>" class='btn btn-danger' value="Eliminar" class='fa fa-trash'></td> 
                               </label>
                                    </form>
                     ...
                     <form method="post" action="../C/Controlador_Coment.php">
                       <input type="hidden" name="idident" value="<?php echo $mostrar['idInfo_Requerimiento']?>">
                         <label>
                          <td><input type="Submit" id="<?php echo $mostrar['idInfo_Requerimiento'] ?>" class='btn btn-info' value="Ver Comentarios"></td> 
                               </label>
                                    </form>
...
<div class="row">
<a href="Index.html"><button type="button" class="btn btn-primary" id="regre">REGRESAR</button></a>
<a href="../Sesiones/Logout.php"><button type="button" class="btn btn-primary" id="sesioncer">CERRAR SESION</button></a>
</div>
