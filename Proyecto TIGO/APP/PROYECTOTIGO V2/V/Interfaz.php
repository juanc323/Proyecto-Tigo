...
<div class="container">
 ...
 <center><h1>PROYECTO TIGO</h1></center>   
        ...
        <div class="col-lg-12 col-lg-12" >
            ...
            <div class="panel panel-default panel-table">
                ...
                <div class="row">
                  ...
                  session_start();
                   ...
                   <?php 
                     ...
                     <h3 class="panel-title">Hola <?php echo $mostrar[0] ?></h3>
                     <?php 
	                    }
	                  ?>
                  </div>
                  <div class="col col-xs-6 text-right">
                    <a href="CrearReq.php"><button type="button" class="btn btn-sm btn-primary btn-create">Crear Nuevo Requerimiento</button></a>
              ...
              <div class="panel-body col-lg-12">
                <table class="table table-striped table-bordered table-list">
                 ...
                 $result=mysqli_query($conexion,$sql);
                     ...
                     <td><button type='button' class='btn btn-sm btn-primary btn-create'>Ver Comentarios</button></td>
                     </tr>
              ...
              <div class="panel-footer">
                <div class="row">
                  <div class="col col-xs-4">Pagina 1 de
                  </div>
...
<center><a href="Index.html"><button type="button" class="btn btn-primary">REGRESAR</button</a></center>
<br>
<br>
<center><a href="../Sesiones/Logout.php"><button type="button" class="btn btn-primary">CERRAR SESION</button</a></center>
</body>
</html>